...
ModuleSceneKen::ModuleSceneKen(bool start_enabled) : Module(start_enabled)
{
	...
	// flag animation
	flag.frames.push_back(new SDL_Rect{848, 208, 40, 40});
	flag.frames.push_back(new SDL_Rect{848, 256, 40, 40});
	flag.frames.push_back(new SDL_Rect{848, 304, 40, 40});
	flag.speed = 0.08f;

	girl.frames.push_back(new SDL_Rect{ 624, 16, 32, 56 });
	girl.frames.push_back(new SDL_Rect{ 624, 80, 32, 56 });
	girl.frames.push_back(new SDL_Rect{ 624, 144, 32, 56 });
	girl.speed = 0.04f;

	dudes.frames.push_back(new SDL_Rect{ 552, 8, 63, 70 });
	dudes.frames.push_back(new SDL_Rect{ 552, 72, 63, 70 });
	dudes.frames.push_back(new SDL_Rect{ 552, 136, 63, 70 });
	dudes.speed = 0.04f;

	shitFace.frames.push_back(new SDL_Rect{ 664, 16, 32, 56 });
	shitFace.frames.push_back(new SDL_Rect{ 664, 80, 32, 56 });
	shitFace.speed = 0.04f;

	columbus.frames.push_back(new SDL_Rect{ 704, 16, 48, 56 });
	columbus.frames.push_back(new SDL_Rect{ 704, 80, 48, 56 });
	columbus.frames.push_back(new SDL_Rect{ 704, 144, 48, 56 });
	columbus.speed = 0.04f;

	shitMan.frames.push_back(new SDL_Rect{ 760, 16, 40, 40 });
	shitMan.frames.push_back(new SDL_Rect{ 760, 64, 40, 40 });
	shitMan.frames.push_back(new SDL_Rect{ 760, 112, 40, 40 });
	shitMan.speed = 0.04f;

	tinkyWinky.frames.push_back(new SDL_Rect{ 808, 24, 48, 32 });
	tinkyWinky.frames.push_back(new SDL_Rect{ 808, 72, 48, 32 });
	tinkyWinky.frames.push_back(new SDL_Rect{ 808, 120, 48, 32 });
